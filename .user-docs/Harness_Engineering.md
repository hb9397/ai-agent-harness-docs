...
| 현재 `0.4.1` runtime 19종 | 설치된 `harness-kit` 플러그인 | local copy를 남기지 않음 |
...
Phase 5에서 `pre-commit`을 제거한 source inventory와 `0.4.1` generated runtime은
...
- [x] `0.4.1` CLI 설치 smoke가 격리 설정에서 통과한다.
