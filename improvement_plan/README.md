...
| 위치 | 상태 | 설명 |
|------|------|------|
| [20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md](./20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md) | Track A Phase 9 완료 / Track B Phase B6 완료 / Phase B7 실행 승인 대기 | Track B의 public routing contract 변경을 포함한 `harness-kit` `0.4.0` archive를 로컬에서 재생성했다. Codex·Claude runtime은 각각 19 skills / 0 agents이며 기존 archive는 보존한다. `not-release-ready` 수동 gate와 실제 host install·trust·모델 호출 증적은 B7에 남아 있다. |
