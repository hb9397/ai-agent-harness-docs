...
| 위치 | 상태 | 설명 |
|------|------|------|
| [20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md](./20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md) | Track A Phase 9 완료 / Track B Phase B2 완료 / Phase B3 실행 승인 대기 | `harness-kit` `0.3.1` 후보의 Track A는 `main`에 push됐고 `not-release-ready` 수동 gate를 유지한다. Track B는 dual-host baseline(B0), portable bundle(B1), setup initial/update/recovery/manual adoption 및 approval-gated lifecycle(B2)을 고정했다. 실제 host install·trust와 plugin 재생성은 수행하지 않았다. |
