...
| 위치 | 상태 | 설명 |
|------|------|------|
| [20260803/260803-1.harness-kit-plugin-rename-and-example-removal-impl-doc.md](./20260803/260803-1.harness-kit-plugin-rename-and-example-removal-impl-doc.md) | Phase 2 root example 제거 완료 / 후속 Phase 대기 | plugin ID를 `harness-kit`, marketplace를 `hb9397`로 전환하고, root `example/`을 외부 저장소 없이 제거하는 impl-doc 계획 |
