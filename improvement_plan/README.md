...
| 위치 | 상태 | 설명 |
|------|------|------|
| [20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md](./20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md) | Track A Phase 9 완료 / Track B Phase B7 자동 검증 완료 / 직접 인터페이스 증적 대기 | `harness-kit` `0.4.0`의 Codex·Claude CLI 격리 설치 smoke와 plugin-installed·portable-only × Claude·Codex routing fixture가 통과했다. 앱 설치·실제 모델 호출·실제 프로젝트 trust는 별도 수동 증적으로 남아 있으며 `not-release-ready`를 유지한다. |
