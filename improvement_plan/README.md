...
| 위치 | 상태 | 설명 |
|------|------|------|
| [20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md](./20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md) | Track A Phase 2 완료 / Phase 3 실행 승인 대기 | G1로 UI/UX Pro Max `v2.13.0`을 선택했고 observed만 갱신한 뒤, exact source/runtime candidate와 3-way diff를 구성했다. accepted·embedded는 `v2.11.3`으로 불변이며, raw LICENSE hash도 기존 accepted provenance와 일치한다. Track B의 `.claude`·`.codex` 독립 hook, 외부 산출물 의미·형식 정규화, 사용자 19 + 관리자 3 계약은 Track A 이후 구현한다. |
