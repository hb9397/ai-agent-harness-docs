...
| 위치 | 상태 | 설명 |
|------|------|------|
| [20260803/260803-1.harness-kit-plugin-rename-and-example-removal-impl-doc.md](./20260803/260803-1.harness-kit-plugin-rename-and-example-removal-impl-doc.md) | 설계 승인 / 구현 대기 | plugin ID를 `harness-kit`, marketplace를 `hb9397`로 전환하고, root `example/`을 외부 examples 저장소로 이관·검증 후 제거하는 impl-doc 계획 |
