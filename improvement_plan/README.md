...
| 위치 | 상태 | 설명 |
|------|------|------|
| [20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md](./20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md) | 계획 수립 완료 / 구현·승격 승인 대기 | `skill-portfolio-maintainer`의 실제 read-only check·discover 결과를 근거로 UI/UX Pro Max `v2.12.0` 관계 그룹 갱신, `im-not-ai` 403 재확인 및 OpenAI skill-creator reference 영향을 승인형 Phase로 검토하는 impl-doc 계획 |
