...
| 위치 | 상태 | 설명 |
|------|------|------|
| [20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md](./20260803/260803-2.skill-portfolio-upstream-refresh-impl-maintenance.md) | Track A Phase 5 완료 / Phase 6 (G6) 실행 승인 대기 | UI/UX Pro Max `v2.13.0`의 해시 고정 candidate와 G3·G4 승인형 promotion handoff를 기록했다. 이 handoff는 canonical skill·lock·plugin·release를 바꾸지 않으며, 실제 canonical 반입은 G6 승인 이후의 다음 Phase에서만 수행한다. Track B의 `.claude`·`.codex` 독립 hook, 외부 산출물 의미·형식 정규화, 사용자 19 + 관리자 3 계약은 Track A 이후 구현한다. |
